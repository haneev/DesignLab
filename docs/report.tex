...
As mentioned this design uses the sorting system that was described in section~\ref{sec:designs}.
...
As can be seen from the result reports the relevance is order from left to right, and then from top to bottom. 
...
By giving each search result the same width and height we aim to prevent this. 
